...
class roots
{
	...
	public static void main(String[] args)
	{
		...
		if (input1 % 1 != 0) {
			...
			if (input1 < 0 && input2 % 2 == 0) {System.out.println("An even root cannot take a negative value!");}
			
			else {
				
				if (input2 < 1) {System.out.println("A root number can not be less than 1!");}
					 ...
					 while (true) {
						 ...
						 if (numerator != 1) {
						 	...
						 	if (numerator % y == 0) {
							 	...
							 	if (numerator == 1 || numerator == -1) {break;}
						 }

							 else if (numerator % y != 0) {y++;}
		...
		///////////////////////////////////////////
			...
			if (input3 == 0) {System.out.println("Result : " + 0);}

			else if (input3 == 1) {System.out.println("Result : " + 1);}
				...
				if (input2 < 1) {System.out.println("A root number can not be less than 1!");}
				...
				else if (input2 == 1) {System.out.println("Result : " + input3);}
					...
					while (true) {
						...
						if (input3 % x == 0) {
							...
							if (input3 == 1 || input3 == -1) {break;}

						}

						else if (input3 % x != 0) {x++;}
					...
					if (input2 == 2) {
						...
						if (innerM == 1) {
							...
							if (input3 > 0) {System.out.println("Result : " + outerM);}
							else {System.out.println("Result : -" + outerM);}

						}

						else if (outerM == 1) {

							if (input3 > 0 ) {System.out.println("Result : " + " √ " + innerM);}
							else {System.out.println("Result : - " + " √ " + innerM);}

						}

						else {

							if (input3 > 0) {System.out.println("Result : " +  outerM + " √ " + innerM);}
							else {System.out.println("Result : -" +  outerM + " √ " + innerM);}
						...
						if (innerM == 1) {
							...
							if (input3 > 0 ) {System.out.println("Result : " + " √ " + innerM + " (" + input2 + ")");}
							else {System.out.println("Result : - " + " √ " + innerM + " (" + input2 + ")");}

						}

						else {

							if (input3 > 0) {System.out.println("Result : " +  outerM + " √ " + innerM  + " (" + input2 + ")");}
							else {System.out.println("Result : -" +  outerM + " √ " + innerM  + " (" + input2 + ")");}
